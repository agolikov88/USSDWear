package com.agolikov.wearbalance.widgets;
...
public class ProgressViewWear extends ProgressBar {
    ...
    public ProgressViewWear(Context context) {
        super(context);
        init();
    }

    public ProgressViewWear(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ProgressViewWear(Context context, AttributeSet attrs, int defStyle) {
